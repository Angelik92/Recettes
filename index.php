...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <img src="uploads/recipes/1-chocolate-au-mousse.jpg" class="card-img-top" alt="Photo mousse au chocolat">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="uploads/recipes/2-gratin-dauphinois.jpg" class="card-img-top" alt="Photo gratin dauphinois">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn btn-primary">Go somewhere</a>
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="uploads/recipes/3-salade.jpg" class="card-img-top" alt="Photo salade">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn btn-primary">Go somewhere</a>
